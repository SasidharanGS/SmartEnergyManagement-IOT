...
average_power_current_per_date = {date: group[['Power (W)', 'Current (A)']].mean() for date, group in date_dataframes.items()}
dt = date_dataframes[today_date]
average_power = dt['Power (W)'].mean()
average_current = dt['Current (A)'].mean()
